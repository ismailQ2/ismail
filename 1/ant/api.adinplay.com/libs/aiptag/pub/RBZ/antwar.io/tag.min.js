...
function aipAPI(){try{window.console.log.apply(console,"\n %c %c %c tag.min.js 2.0 \u2730 RBZ \u2730  %c  %c  ads by http://www.adinplay.com/  %c %c %c%c \n\n,background: #9C0013; padding:5px 0;,background: #9C0013; padding:5px 0;,color: #FFFFFF; background: #030307; padding:5px 0;,background: #9C0013; padding:5px 0;,color: #FFFFFF;background: #DB0028; padding:5px 0;,background: #9C0013; padding:5px 0;,color: #ff2424; background: #fff; padding:5px 0;,color: #ff2424; background: #fff; padding:5px 0;,color: #ff2424; background: #fff; padding:5px 0;".split(","))}catch(b){}this.debug=this.validateQueryParams("aip_debug",
"true");this.aipAds=null;this.sdkBlocked=this.gptBlocked=this.gptLoaded=this.started=!1;this.timeout_bid_display=900;this.timeout_bid_player=1500;this.timeout_reload_display=5E3;this.queue_ready_display=!0;this.hidden_slot_retry=0;this.adUnits=[];this.adSlots=[];this.adSlot=[];this.adUnitsLoaded=[];this.adUnitsRefreshed=[];this.adUnitsPercentage=[];this.adUnitsRefreshFlag=[];this.gdpr=[];this.gdpr.googleConsent;this.gdpr.googleId=1500;this.protocol=(this.useSSL="https:"===document.location.protocol.toLowerCase())?
"https://":"http://";this.forceUserFrom=this.validateQueryParams("forceUserFrom","EEA");this.displayBidCpm=[];var a=("; "+document.cookie).split("; userFromEEA=");2===a.length&&(this.userFromEEA=a.pop().split(";").shift());!0===this.forceUserFrom&&(this.userFromEEA=!0);aiptag.gdprShowConsentTool=!0;aiptag.gdprConsentToolPosition="bottom";this.adUnits["antwar-io_300x250"]=[{code:"antwar-io_300x250",mediaTypes:{banner:{sizes:[300,250]}},bids:[{bidder:"appnexus",params:{placementId:"13882506"}},{bidder:"pubmatic",
params:{publisherId:"156857",adSlot:"1571515@300x250"}},{bidder:"ix",params:{siteId:"312383",size:[300,250]}}]}];this.adSlots["antwar-io_300x250"]={adunit:"antwar.io_300x250",sizes:[300,250],reload:!0}}
...
aipAPI.prototype.log=function(a,b){if(this.debug){aipAPItag.restoreLog();if("string"==typeof a){var c=(new Date).toLocaleTimeString();c+=":"+(new Date).getMilliseconds();window.console.log.apply(console,["%cAdinPlay","display: inline-block; color: #fff; background: #DD0420; padding: 1px 4px; border-radius: 3px;",c,a])}else console.log(a);b&&console.log(b)}};
...
function aipPlayer(a){this.aipConfig={VERSION:"2.0",AD_WIDTH:960,AD_HEIGHT:540,LOADING_TEXT:"loading advertisement",PREROLL_ELEM:function(){return document.getElementById("preroll")},PREROLL_ELEM_ID:!1,PREROLL_CONTAINER:!1,AD_FULLSCREEN:!1,AD_CENTERPLAYER:!1,AD_FADING:!0,DESCRIPTION_URL:aipAPItag.protocol+"antwar.io/"};a&&this.configure(a);this.videoAdUnit=[];this.videoAdUnit["antwar.io_preroll"]={code:"prerollUnit",mediaTypes:{video:{context:"instream",playerSize:[960,540]}},bids:[{bidder:"appnexus",
params:{placementId:"13882506",video:{skippable:!0,playback_method:["auto_play_sound_on"]}}}]};try{var b=document.createElement("style");this.aipConfig.PREROLL_ELEM_ID="function"===typeof this.aipConfig.PREROLL_ELEM?this.aipConfig.PREROLL_ELEM().id:this.aipConfig.PREROLL_ELEM.id;b.type="text/css";b.innerHTML="#"+this.aipConfig.PREROLL_ELEM_ID+" video {left: 0;top: 0;}";document.getElementsByTagName("head")[0].appendChild(b)}catch(c){}}
...
function AipAds(a,b,c,d){function g(){aipAPItag.sendEvent("video-ad-paused");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).addEventListener("click",e)}catch(z){}}function e(){aipAPItag.sendEvent("video-ad-resumed-forced");f.resume()}function h(){aipAPItag.sendEvent("video-ad-resumed");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",e)}catch(z){}}function l(a){m("EXCEPTION",{name:a.name,message:a.message,stack:a.stack})}function B(a){var b="",c="",d=
"";try{b=a.getAd().getContentType(),c=a.getAd().getMinSuggestedDuration(),d=a.getAd().getCreativeId()}catch(D){l(D)}m("CONTENT_PAUSE_REQUESTED",{contentType:b,creativeId:d,minSuggestedDuration:c})}function C(b){n();c.style.display="block";a.showLoading(!1);a.showBranding();a.aipConfig.AIP_STARTED&&a.aipConfig.AIP_STARTED();try{aipAPItag.forceRedraw(document.getElementById(a.aipConfig.PREROLL_ELEM_ID))}catch(w){}if(d)try{m("MediaUrl: "+b.getAd().getMediaUrl()+"; AdvertiserName: "+b.getAd().getAdvertiserName()+
"; Description: "+b.getAd().getDescription()+"; Title: "+b.getAd().getTitle())}catch(w){l(w)}m("STARTED");aipAPItag.sendEvent("video-ad-started")}function u(){try{clearTimeout(aipAPItag.completedTimeoutPreroll)}catch(z){}p.contentComplete();f.destroy();m("CONTENT_RESUME_REQUESTED");r=!1;n();a.aipComplete();aipAPItag.sendEvent("video-ad-removed")}function y(b){n();m(b.getError());p.contentComplete();f&&f.destroy();var c=(new Date).getTime()-A;1012==b.getError().getErrorCode()&&0<=c&&800>c?(m("AD BLOCKED",
{timeElapsed:c}),a.aipConfig.AIP_BLOCKED&&a.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock")):b.getError().getErrorCode()==google.ima.AdError.ErrorCode.VAST_EMPTY_RESPONSE||901==b.getError().getErrorCode()&&b.getError().getInnerError()&&"Error: No ads available"==b.getError().getInnerError().message?(m("NO ADS",{errorCode:b.getError().getErrorCode(),message:b.getError().getMessage(),innerError:b.getError().getInnerError(),vastErrorCode:b.getError().getVastErrorCode(),timeElapsed:c}),
a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-empty")):(m("ERROR",{errorCode:b.getError().getErrorCode(),message:b.getError().getMessage(),innerError:b.getError().getInnerError(),vastErrorCode:b.getError().getVastErrorCode(),timeElapsed:c}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-error"));r=!1;n();a.aipComplete()}function q(){x=!0;r=!1;p.contentComplete();f&&f.destroy();m("TIMEOUT");n();a.aipComplete();aipAPItag.sendEvent("video-ad-timeout")}
function n(){t&&(clearTimeout(t),t=null)}function v(){a.aipConfig.AD_FULLSCREEN?(windowWidth=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,windowHeight=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight):(windowWidth=b.offsetWidth,windowHeight=b.offsetHeight);return{adWidth:windowWidth,adHeight:windowHeight}}var p,f,r,A,t,x,m=function(){};window.addEventListener("error",function(a){if(r)try{m("WINDOW_EXCEPTION",{name:"WindowErrorListener: "+
a.error.toString(),message:a.error.toString(),stack:a.error.stack})}catch(w){}});(function(){var d=new google.ima.AdDisplayContainer(c);d.initialize();p=new google.ima.AdsLoader(d);p.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);p.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(c){function d(a){return function(){"COMPLETE"==a&&(aipAPItag.sendEvent("video-ad-completed"),aipAPItag.completedTimeoutPreroll=setTimeout(u,1500));"CLICK"==a&&aipAPItag.sendEvent("video-ad-clicked");
"USER_CLOSE"==a&&aipAPItag.sendEvent("video-ad-close");"SKIPPED"==a&&aipAPItag.sendEvent("video-ad-skipped");m(a)}}if(!x){var e=new google.ima.AdsRenderingSettings;e.loadVideoTimeout=12E3;f=c.getAdsManager(b,e);f.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,y);f.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,B);f.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,u);f.addEventListener(google.ima.AdEvent.Type.STARTED,C);f.addEventListener(google.ima.AdEvent.Type.SKIPPED,
d("SKIPPED"));f.addEventListener(google.ima.AdEvent.Type.CLICK,d("CLICK"));f.addEventListener(google.ima.AdEvent.Type.PAUSED,g);f.addEventListener(google.ima.AdEvent.Type.RESUMED,h);f.addEventListener(google.ima.AdEvent.Type.FIRST_QUARTILE,d("FIRST_QUARTILE"));f.addEventListener(google.ima.AdEvent.Type.MIDPOINT,d("MIDPOINT"));f.addEventListener(google.ima.AdEvent.Type.THIRD_QUARTILE,d("THIRD_QUARTILE"));f.addEventListener(google.ima.AdEvent.Type.LOADED,d("LOADED"));f.addEventListener(google.ima.AdEvent.Type.COMPLETE,
d("COMPLETE"));f.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,d("USER_CLOSE"));f.addEventListener(google.ima.AdEvent.Type.SKIPPABLE_STATE_CHANGED,d("SKIPPABLE_STATE_CHANGED"));try{var n=v();a.aipConfig.AD_FULLSCREEN?f.init(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight,google.ima.ViewMode.FULLSCREEN):f.init(n.adWidth,n.adHeight,google.ima.ViewMode.NORMAL);f.start()}catch(E){l(E)}}});
p.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,y)})();window.addEventListener("resize",function(){if(f&&r){var b=v();a.aipConfig.AD_FULLSCREEN?f.resize(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight,google.ima.ViewMode.FULLSCREEN):f.resize(b.adWidth,b.adHeight,google.ima.ViewMode.NORMAL)}});this.requestAds=function(a,b){m=b;A=(new Date).getTime();var c=new google.ima.AdsRequest;
c.adTagUrl=a;var d=v();c.linearAdSlotWidth=d.adWidth;c.linearAdSlotHeight=d.adHeight;c.nonLinearAdSlotWidth=d.adWidth;c.nonLinearAdSlotHeight=d.adHeight;c.forceNonLinearFullSlot=!0;c.setAdWillAutoPlay(!1);c.setAdWillPlayMuted(!1);p.requestAds(c);t=setTimeout(q,15E3);x=!1;r=!0}}aipAPItag=new aipAPI;aipAPItag.setCurrency();aipAPItag.detectBlockedAds();aipAPItag.initGDPR();